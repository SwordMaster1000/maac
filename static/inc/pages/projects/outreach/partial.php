...
<div class="viewing page__base" data-route="^\/projects\/outreach\/?(.*)$">
    <div class="outreach">
        ...
        <hr>
        <p class="outreach-p">
            In addition, MACH participated in the iHeartRadio awareness campaign.
            <br><br> We also hosted an outreach party for MAAC sponsors; it was held October 20th at Azalea Hills Christian
            Church Disciples, Mobile, AL.
        </p>
        <br>
        <br>
        <br>
