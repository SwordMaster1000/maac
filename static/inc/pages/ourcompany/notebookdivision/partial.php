...
<div class="viewing page__base" data-route="^\/ourcompany\/notebookdivision\/?(.*)$">
    <h2 class="ourcompany__heading animated fadeIn">
        Engineering Notebook Division
    </h2>
    <img width="70%" class="ourcompany__img animated fadeIn" src="/static/imgs/team/notebook.jpg" alt="Group photo of the MAAC Notebook Division">
