...
<div class="viewing page__base" data-route="^\/ourcompany\/spirit\/?(.*)$">
...
-Samuel Werry
        <span class="hr"></span>
        <br>
       The Spirit Division<br>
        - Makes spirit signs<br>
        - Encourages the team with fun, catchy cheers<br>
        - Makes give-a-ways to show sportsmanship<br>
        - Writes thank you cards for showing our appreciation to our sponsors<br>
