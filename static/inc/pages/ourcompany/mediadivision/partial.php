...
<div class="viewing page__base" data-remote="true" data-route="^\/ourcompany\/mediadivision\/?(.*)$">
    <h2 class="ourcompany__heading animated fadeIn">
        Media Division
    </h2>
    <img width="70%" class="ourcompany__img animated fadeIn" src="/static/imgs/team/media.jpg" alt="Group photo of the MAAC Media Division">
    <p class="ourcompany__about animated fadeIn">
       Our Media Division is in charge of managing our social media sites such as facebook, instagram and twitter. They are responsible for developing our website, and producing commercials. They act as our main means of connecting to the community. 
        <br>
        <span class="hr"></span>
        <br>
        The Media Division<br>
        - Designs a website and app<br>
        - Produces a commercial<br>
        - Handles our social media sites<br>
        - Drafts a brochure<br>
    </p>
</div>
