...
<div class="viewing page__base" data-route="^\/ourcompany\/displaydivision\/?(.*)$">
    <h2 class="ourcompany__heading animated fadeIn">
        Display Division
    </h2>
    <img width="70%" class="ourcompany__img animated fadeIn" src="/static/imgs/team/display.jpg" alt="Group photo of the MAAC Display Division">
    <p class="ourcompany__about animated fadeIn">
      The Display Division is responsible for sharing all of the hard work that our team accomplishes over the course of six weeks.  They build a trade-show style display that not only shows what the team has done, but also shows the development of our company.  They have to show evidence of recruiting, fund-raising, publicity, use of technology, understanding of the game theme, and the designing of the robot.
    </p>
</div>
