...
<div class="viewing page__base" data-route="^\/ourcompany\/marketingdivision\/?(.*)$">
    <h2 class="ourcompany__heading animated fadeIn">
        Marketing Division
    </h2>
    <img width="70%" class="ourcompany__img animated fadeIn" src="/static/imgs/team/marketing.jpg" alt="Group photo of the MAAC Marketing Division">
    <p class="ourcompany__about animated fadeIn">
       The Marketing Division is responsbile for introducing our product to potential clients. They present the company as an organized group working toward one goal. They travel to schools and community groups, marketing our company and product, raising awareness of BEST Robotics and of our team. They are the face of MACH Automated Agricultural Company.
    </p>
</div>
