...
<div class="viewing page__base" data-route="^\/sponsors\/?(.*)$">
    ...
    <p class="top-sponsors">
        <img src="/static/imgs/logos/HIS.png" alt="Holland Industrial Services">
        <img src="/static/imgs/logos/locale.png" alt="The Locale">
        <img src="/static/imgs/logos/PCM.png" alt="Port City Metal">
        <img src="/static/imgs/logos/GSA.jpg" alt="Port City Metal">
        <img src="/static/imgs/logos/silverships.png" alt="Silver Ships INC.">
    </p>
